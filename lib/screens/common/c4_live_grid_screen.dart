...
class _C4LiveGridScreenState extends State<C4LiveGridScreen> {
  ...
  List<ContentItem> get _currentCategoryChannels {
    ...
    if (controller.liveCategories == null || _selectedCategoryIndex >= controller.liveCategories!.length) {
      return [];
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isFullscreen = fullscreenNotifier.value;
    ...
    return Row(
      ...
      children: [
        // 1. Categories Sidebar (Left, 200px) - Hidden in fullscreen
        if (!isFullscreen)
          Container(
            width: 200,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                // Bottom Half: Search + Channel List - Hidden in fullscreen
                if (!isFullscreen)
                  Expanded(
                    child: Padding(
        ...
        // 3. Info Panel (Right, 320px) - Hidden in fullscreen
        if (!isFullscreen)
          Container(
            width: 320,
            decoration: BoxDecoration(
